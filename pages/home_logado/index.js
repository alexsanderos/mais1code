  ...
  return (
    <main className={styles.corpo}>
      <section className={styles.criarPublicacao}>
        <img
          src="Icones/usuario-de-perfil.png"
          alt="#"
        ...
        <form action="#" method="get">
          <input
            ...
            placeholder="Como você deseja se inspirar hoje?"
          />
        </form>
        <img
          src="Icones/carregar.png"
          alt="#"
          className={styles.midia}
        />
        <img
          src="Icones/pasta.png"
          alt="#"
      ...
      <section className={styles.post}>
        ...
        <img
          src="Icones/gostar.png"
          alt="#"
          className={styles.curtida}
        />
        <img
          src="Icones/Comentar.png"
          alt=""
          className={styles.comentar}
        />
        <form action="#" method="get">
          <input type="text" className={styles.comentario} />
        </form>
        <img
          src="Icones/compartilhar.png"
          alt="#"
      ...
      <section className={styles.post}>
        ...
        <img
          src="Icones/joses.png"
          alt=""
          className={styles.fotoPost2}
        />
        <p className={styles.textoPost}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce
          feugiat, dui vitae fringilla mollis, lacus augue tristique est, id
